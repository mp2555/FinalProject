...
public class ProjectController {
	...
	public String projectUptMethod(ProjectDTO dto, HttpServletRequest request) {
		...
		// 기존의 이미지 파일이 있으면
		if (pro_pic != null) {
			String root = "C:/Users/user1/git/FinalProject/FinalProject/src/main/webapp/files";
		...
		if (dto.getPic_change() != 0) {
			...
			String dd = "C:/Users/user1/git/FinalProject/FinalProject/src/main/webapp/files";
			// 중복파일명을 처리하기 위해 난수 발생
			UUID random = UUID.randomUUID();

			// System.out.println(dto.getPic_change());
			String saveDirectory = dd + File.separator;
