				...
				<div id="outline">
					...
					<div class="divi" id="divi2">
						...
						<div id="table-inner2"  class="inner container" ondragover="return false;" ondragenter="return false;" ondrop="drop(this, event);">
							...
							<div class="small-table" draggable="true" id="small4" ondragstart="drag(this, event)">
								<div>
									<p>할당된 사람 : 이은비</p>
									<h2 id="kanban-name">
										<a href="#">제목 : D</a>
					...
					<div class="divi" id="divi3">
						...
						<div id="table-inner3" class="inner" ondragover="return false;" ondragenter="return false;" ondrop="drop(this, event);">
							<div class="small-table" id="small5" ondragstart="drag(this, event)" draggable="true">
								<div>
									<p>할당된 사람 : 주수경</p>
									<h2 id="kanban-name">
										<a href="#">제목 : E</a>
